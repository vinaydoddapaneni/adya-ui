...
export class AuiDatePicker extends AuiElement {
    ...
    render() {
        ...
        let daysHTML = '';
        // Previous month days
        const prevMonthDays = this.getDaysInMonth(this.currentMonth === 0 ? this.currentYear - 1 : this.currentYear, this.currentMonth === 0 ? 11 : this.currentMonth - 1);
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            if (isToday)
                classes += ' aui-datepicker__day--today';
            if (isSelected)
                classes += ' aui-datepicker__day--selected';
            if (isDisabled)
                classes += ' aui-datepicker__day--disabled';
...
//# sourceMappingURL=aui-datepicker.js.map